...
<html>
  <head>
    ...
    <title>Chitra Agro Firm Ltd | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-mini"><b>Chitra</b>Agro</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">Chitra Agro Firm Ltd</span>
        </a>
          ...
          <div class="row">
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  ...
                  <li class="pull-left header"><i class="fa fa-inbox"></i> Cattle Mik Sales</li>
                </ul>
              ...
              <div class="box box-success">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Stuff Communication</h3>
            ...
            <section class="col-lg-5 connectedSortable">
              ...
              <div class="box box-solid bg-teal-gradient">
                <div class="box-header">
                  <i class="fa fa-th"></i>
                  <h3 class="box-title">Cattle Beef Sales</h3>
                  <div class="box-tools pull-right">
                ...
                <div class="box-footer no-border">
                  <div class="row">
                    <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                      ...
                      <div class="knob-label">Local Market</div>
                    </div><!-- ./col -->
                    <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                    ...
                    <div class="col-xs-4 text-center">
                      ...
                      <div class="knob-label">Rajshahi</div>
                    </div><!-- ./col -->
                  </div><!-- /.row -->
                </div><!-- /.box-footer -->
                <div class="box-footer no-border">
                  <div class="row">
                    <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                      <input type="text" class="knob" data-readonly="true" value="20" data-width="60" data-height="60" data-fgColor="#39CCCC">
                      <div class="knob-label">Khulna</div>
                    </div><!-- ./col -->
                    <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                      <input type="text" class="knob" data-readonly="true" value="50" data-width="60" data-height="60" data-fgColor="#39CCCC">
                      <div class="knob-label">Rangpur</div>
                    </div><!-- ./col -->
                    <div class="col-xs-4 text-center">
                      <input type="text" class="knob" data-readonly="true" value="30" data-width="60" data-height="60" data-fgColor="#39CCCC">
                      <div class="knob-label">Sylhet</div>
                    </div><!-- ./col -->
                  </div><!-- /.row -->
                </div><!-- /.box-footer -->
              </div><!-- /.box -->
