...
<html>
  <head>
    ...
    <title>Chitra Agro Firm Ltd | Blank Page</title>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="bootstrap/ionic/css/ionicons.min.css">
    <!-- Theme style -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-mini"><b>CAFL</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Chitra Agro</b> Firm LTD</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Iqbal Hossain</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <p class="login-box-msg">Register a new Suff</p>
        <form action="index.php" method="post">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Enter Stuff Full name">
          ...
          <div class="form-group has-feedback">
            <input type="email" class="form-control" placeholder="Enter Stuff Email Address">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
           <input type="text" class="form-control" placeholder="Enter Stuff Mobile Number">
            <span class="glyphicon glyphicon-earphone form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Enter Stuff Username">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
            <select class="form-control select2" style="width: 100%;">
                      <option selected="selected">Select Stuff Role</option>
                      <option>Project Manager</option>
                      <option>Item Head Manager</option>
                      <option>General Stuff</option>
                      <option>Advance Stuff</option>
                    </select>
          </div>
          <div class="row">
            <div class="col-xs-8">
              <div class="checkbox icheck">
                <label>
                  <input type="checkbox" style="margin: 0;position: static;"> I agree to the <a href="#">terms</a>
                </label>
              </div>
            </div><!-- /.col -->
            <div class="col-xs-4">
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>Version</b> 1.0 Mockup
        </div>
        <strong>Copyright &copy; 2016 <a href="#">Chitra Agro Firm Ltd</a>.</strong> All rights reserved.
      </footer>
